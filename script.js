...
const correctMundoListUL = document.getElementById("correctMundo");
...
const crrctHTML = correctMundo.map(crrMundo=>{
...
waitList.filter(member =>!member.is_bot)
